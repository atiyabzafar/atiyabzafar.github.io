...
@def title = "Love Letters to Pi(3): The normality of pi"
@def description = "Third part of my love letters to pi, where I talk about the idea of normal numbers."
@def rss_title = "Love Letters to Pi(3): The normality of pi"
@def rss_description = "Third part of my love letters to pi, where I talk about the idea of normal numbers."
@def rss_pubdate = Date(2020,03,14)
@def og_image = "/Old_blog/2021-03-14-pi/images/PiNeverEnds2-1-1024x764.png"
...
I am pretty sure you have heard of it before. It is one of the most famous number in the world. π is a ratio that we come across if we study mathematics even at an elementary Level. You must already know that it has an unending infinite decimal expansion (Explored in previous post on [how to calculate pi](/Old_blog/2019-07-03-calculating-pi-recursively-love-letters-to-pi/2019-07-03-calculating-pi-recursively-love-letters-to-pi/)) . In this post we will talk about the beauty of pi in detail (See [last year's pi day post](/Old_blog/2020-03-14-love-letters-to-pi-surprising-places-where-pi-pops-up-celebrating-pi-day/pi2/) about surprising places pi appears in), discuss what are normal numbers and show (not prove) that π most probably is a normal number.
